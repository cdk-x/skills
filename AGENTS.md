...
├── definition-of-done/     → Create/update Definition of Done as a Confluence page
├── definition-of-ready/    → Create/update Definition of Ready as a Confluence page
...
├── iteration-plan/         → Split refined Jira Stories into technical sub-tasks
├── refine-story/           → Full refinement session for a Jira Story
├── user-story/             → Create Jira Epic and Story issues from a PRD
└── (future skills)
```
...
| `definition-of-done` | `skills/definition-of-done/` | The Definition of Done Confluence skill |
| `definition-of-ready` | `skills/definition-of-ready/` | The Definition of Ready Confluence skill |
| `plan` | `skills/plan/` | The technical plan skill |
| `prd` | `skills/prd/` | The PRD skill |
| `iteration-plan` | `skills/iteration-plan/` | The iteration planning + task split skill |
| `prd-to-issues` | `skills/prd-to-issues/` | The PRD-to-issues skill |
| `refine-story` | `skills/refine-story/` | The Jira story refinement skill |
| `user-story` | `skills/user-story/` | The Jira Epic/Story skill |
